...
# This is necessary to import the src.params module correctly
import sys
import os
...
class TestRelayHardware(unittest.TestCase):
    ...
    def test_turn_on_and_off_relay(self):
        ...
        dev: Device = usb.core.find(
            idVendor=VENDOR_ID, idProduct=PRODUCT_ID)  # type: ignore
        if dev is None:
        ...
        dev.ctrl_transfer(
            bmRequestType=0x21, bRequest=9, wValue=0x200,
